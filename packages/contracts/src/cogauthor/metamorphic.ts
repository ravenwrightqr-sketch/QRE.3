/**
 * QRE COGAUTHOR · METAMORPHIC SEMANTICS
 *
 * A metamorphic relation is an interpretation of supplied reality that explains
 * how one supplied detail changes the meaning of another. It is not prose,
 * chronology, a new event, or permission to invent concrete reality.
 */
import type {
  LatentSemanticCreativeOpportunity,
  LatentSemanticMechanism,
  LatentSemanticRealizationMove,
} from "../experience/latentMovie.js";
