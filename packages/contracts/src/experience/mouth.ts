/**
 * QRE MOUTH CONTRACTS · CANONICAL SHARED AUTHOR REALIZATION TYPES
 *
 * These are semantic structures shared by multiple Author/Mouth services.
 * They are internal authoring contracts, not viewer-facing prose.
 */
