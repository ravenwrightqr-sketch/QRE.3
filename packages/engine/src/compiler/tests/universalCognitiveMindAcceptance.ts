...
const cases = [
  ...
  },
  {
    ...
    anchors: ["Alex", "Sam", "Italian restaurant", "7 PM", "closing"],
  },
  {
    name: "event night",
  ...
  {
    name: "horror lens",
    prompt: "We returned to the restaurant where we met. The chairs were suddenly circled around us and the lights went out. Make it horror.",
...
const resolved = compileCognitiveExperience("We went back two weeks later at 7 PM.", {
...
const ambiguous = compileCognitiveExperience("We went back two weeks later at 7 PM.", {
...
const learning = compileCognitiveExperience("Coco stole the blue bow.", {
  creativePreferences: ["playful", "short sentences"],
  feedback: { accepted: ["absurd interpretation"], rejected: ["generic opener"] },
});
