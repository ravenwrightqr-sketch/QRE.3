...
A clause such as `Alex and Sam went back...` is a shared event with two identities, not one actor named `Alex and Sam`.

The world model therefore keeps a participant list per event and carries those identities forward into:

- entity extraction
- relationship reasoning
- event evidence
- creative candidate ranking
- runtime moment payloads

This rule is universal. It applies equally to couples, families, teams, pets with owners, businesses with customers, objects with owners, collectors and collectibles, event attendees, creators and collaborators, and any other multi-entity experience.
...
- multi-participant identity conservation
- memory resolution
- ambiguity handling
