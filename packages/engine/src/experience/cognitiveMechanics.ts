...
const RULES: readonly Rule[] = [
  ...
  { mechanic: "ownership", score: 0.9, pattern: /\b(?:ownership|mine|my own|personal artifact|personalized artifact|keep forever|belongs to|take home|keepsake|souvenir|claim)\b/, evidence: "the participant gains durable possession or authorship" },
