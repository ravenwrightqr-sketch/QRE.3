...
export type CognitiveCompiledExperience=Omit<CompiledExperienceV16,"moments"|"cinematicScenes">&{observation:ExperienceObservation;situation:CognitiveSituation;candidates:CognitiveCandidate[];genome:ExperienceGenome;story:ExperienceStory;scenePlan:StoryScenePlan[];model:ExperienceModel;moments:Moment[];cinematicScenes:CinematicScene[]};
