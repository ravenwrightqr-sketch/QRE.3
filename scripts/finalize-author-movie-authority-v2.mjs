...
replaceOnce(
  BRAIN,
  /import \{\r?\n  recoverBeatPlanFromLatentMovie,\r?\n\} from "\.\/authorBeatPlanRecovery\.js";/m,
...
replaceOnce(
  BRAIN,
  /function buildFallbackBeatPlan\([\s\S]*?\r?\n}\r?\n\r?\nfunction buildBeatMessages/m,
...
replaceOnce(
  MOVIE,
  /  const ordered = unique\(\r?\n    convergence\.forwardPath\.length \? convergence\.forwardPath : anchors,\r?\n  \);/m,
