...
const reality = {
  prompt: "Create a customer-facing experience for Coco's visit.",
  subject: "Coco",
  facts: [
...
assert.match(contextualText, /Elm St Dog Grooming|groom|grooming/i, "business context did not reach the visible Author realization");
