...
if (result.diagnostics.modelCalls !== 1) throw new Error("AUTHOR INVARIANT FAILED: expected exactly one model call");
if (!result.diagnostics.complete) throw new Error("AUTHOR INVARIANT FAILED: no complete authored sequence");
