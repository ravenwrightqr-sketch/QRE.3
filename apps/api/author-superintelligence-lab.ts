...
const ARTIST_CHARTER = [
  ...
  "The experience's form must be earned by this reality. Do not force the same opening, beat count, sentence shape, or ending shape across worlds.",
  "A small experience may be 2 cuts. A richer reality may need many more. Length is earned by the creative idea and the amount of living material available.",
...
const cases: Case[] = [
  ...
  { name:"PAUL / RADIOS", subject:"Paul", prompt:"Make a compact experience about the supplied radio details. Let the relationship between repair, inheritance, repetition and the desk create something worth remembering.", facts:["Paul restores old radios","Paul repaired 17 radios this year","The first radio belonged to his grandfather","The first radio still works","Paul keeps that radio on his desk","Paul repaired its tuning knob himself","The desk radio is the one radio Paul never sells","A newer radio sits beside it"] },
  ...
  { name:"RAVE / INTERRUPTION", subject:"the event", prompt:"Make this feel physically lived, not poetically observed. The sound and light are source reality. Find the creative form hidden inside impact, silence, waiting, return, repetition and restart. The piece may become a system, ritual, game, release, collision, or something stranger when the supplied reality earns it. Do not invent crowd psychology or literal bodily events that were not supplied.", facts:["Doors opened at 9 PM","The first set began at 10 PM","The room was dark","Lights flashed with the music","Bass vibrated through the room","The music was felt through the body","The bass system failed at 11:20 PM","The room went suddenly quiet","The crowd waited in the darkness","The bass system returned at 11:34 PM","The DJ restarted exactly where the track had stopped","The next track began immediately after the restart","The return of the bass felt like bliss","The music stayed with the user deeply after the set"] },
...
for(const test of cases){
  ...
  if(test.facts.length>=7 && texts.length<4) console.log("NOTE: rich reality produced a compact experience; this is not a failure because length is artist-determined.");
