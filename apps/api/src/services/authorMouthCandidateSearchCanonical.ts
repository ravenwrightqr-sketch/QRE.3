...
function buildSystemPrompt(): string {
  return [
    ...
    "Invent language, never concrete reality.",
    ...
    "Do not summarize, explain, enumerate facts, narrate the system, or describe a camera, scene, body movement, gesture, sensory detail, dialogue, chronology, or new event.",
    ...
    "A lens or genre changes framing, attitude, status, rhythm, metaphor, and implication; it never creates a concrete occurrence.",
    "The intended effect is: supplied detail → pressure or surprise → viewer recognition.",
    "The line may be fragmentary, funny, strange, sharp, ironic, tender, hostile, ceremonial, or absurd when grounded.",
    "Do not repeat the source as a receipt. Make the viewer feel what the supplied relationship means.",
