...
function buildSystemPrompt(): string {
  return [
    ...
    "Find the strongest movement already available in the supplied reality.",
    "Some truths are occurrences; others are identity, preference, trait, relationship, memory, state, or desire. Do not silently turn one kind of truth into another.",
    "If the world actually moved, use that movement. If the world is static, move the viewer's understanding instead.",
    "A preference or trait may be creatively evoked as desire, anticipation, emphasis, thought-pressure, character voice, repetition, implication, or attitude without claiming the event happened.",
    "Example: 'Milo likes walks' may become 'Walk. Walk. Walk?' or another expressive realization; it does not authorize 'Milo ran to the park.'",
