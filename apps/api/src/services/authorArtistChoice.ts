      ...
      [
        {
          ...
          content: [
            ...
            "MECHANIC DEFINITION: the mechanic is a representation or framing device applied to supplied reality. It may group, rank, contrast, count, label, repeat, compare, investigate, or recontextualize facts that already exist. It does not create new real-world behavior.",
            "The mechanic must be VISUAL/EDITORIAL/INTERPRETIVE, not an invented event. Prefer things like a priority order, recurring caption pattern, contrast between rooms, a mock rule applied to known facts, a countdown using an already-known sequence, a reveal that reinterprets an earlier supplied fact, or a game-like framing of existing evidence.",
            "Do not make the mechanic depend on someone newly doing something. Do not make a shelf rotate, a person speak, an animal think, a worker change pace, a customer make a choice, an object move, a room change, or a new event occur unless the supplied reality explicitly says it happens.",
            "IMPORTANT REALITY BOUNDARY: framing may be invented; concrete subject behavior, people, places, objects, actions, outcomes, routines, physical changes, business operations, thoughts, motives, dialogue, and future events may not be invented.",
            "Do not invent a new person, employee, customer, animal, object, sign, rule, rotation, ranking, transaction, event, physical effect, sound, thought, dialogue, motive, or outcome.",
            "A known subject may be given a playful interpretive label such as 'has a system' or 'runs on priorities'. That does not license invented actions, inner thoughts, or new facts.",
            "For example, 'Coco has a system' can organize supplied facts such as walks, grass, squirrels, apples, and bacon. It can become a priority hierarchy using those facts. It cannot invent Coco earning points, completing a mission, or encountering a new event.",
            "For housekeeping, the cat may be an interpretive observer because the cat is supplied, but do not invent the cat's thoughts, dialogue, secret standards, missed crumbs, or new reactions.",
            "For the shelf, existing facts about grouped flavors, behind-counter stock, trying products, and replenishment can become a flavor/replenishment system. Do not invent shelf movement, customer choices, signage, sounds, or hidden operational behavior.",
            "Creative devices such as points, missions, ranks, investigations, mock rules, labels, meters, or recurring jokes are allowed only as representational framing over existing facts. The inputs to the device must already be supplied.",
            ...
            "Every field must stay grounded in the supplied reality. A creative field may describe a framing device, but it must not introduce an unsupplied concrete fact or unsupplied behavior.",
