...
const LENSES: Record<string, AuthorLensProfile> = {
  ...
  battle: { kind: "custom", label: "battle", framingBias: ["opposition", "territory", "pressure", "clearance", "progression", "objective", "victory", "aftermath"], realizationPreferences: ["status_inversion", "compression", "consequence", "reversal", "understatement"], forbiddenRealityMoves: ["invented combat", "invented opponent", "invented weapon", "invented damage", "invented casualty"], intensity: 0.84 },
  cyberpunk: { kind: "custom", label: "cyberpunk", framingBias: ["system", "signal", "protocol", "grid", "trace", "status", "upgrade", "glitch", "clearance"], realizationPreferences: ["compression", "status_inversion", "recontextualization", "double_meaning", "callback"], forbiddenRealityMoves: ["invented technology", "invented device", "invented network event", "invented surveillance", "invented physical effect"], intensity: 0.82 },
...
const LENS_ALIASES: Record<string, string> = {
  ...
  army: "military", combat: "military", caper: "heist", surveillance: "spy", espionage: "spy",
