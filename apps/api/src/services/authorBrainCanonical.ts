...
async function realize(input: {
  ...
  const system = [
    ...
    "Silently explore several genuinely different readings of the supplied reality before writing. Choose the one with the strongest surprise, character, status shift, contrast, implication, callback, tension, humor, tenderness, weirdness, or other earned charge. Do not reveal the rejected readings.",
