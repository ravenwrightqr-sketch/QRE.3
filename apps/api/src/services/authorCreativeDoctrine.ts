...
export const QRE_CREATIVE_OPERATING_DOCTRINE = [
  ...
  "Do not solve creativity with synonyms. Vocabulary substitution without a governing sequence idea is not authorship.",
  "Do not explain the joke, metaphor, attitude, or meaning after it lands.",
  "Do not invent people, objects, places, actions, sensory facts, motives, outcomes, chronology, recurrence, or physical conditions.",
  "If an expressive idea appears to require invented reality, keep the idea and realize it more abstractly instead of flattening it.",
