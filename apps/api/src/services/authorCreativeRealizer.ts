  ...
  try {
    const result = await localModelGenerate([
      { role: "system", content: [
        ...
        "LENS FREEDOM: You may use metaphor, irony, personification, status moves, exaggeration, juxtaposition, surreal framing, rhetorical questions and genre language. 'Kitchen TKO', 'round 2', 'super power up', 'chairs on the ceiling', 'case closed', 'the house surrendered', and 'objective complete' can be excellent when earned by the supplied material and the selected frame. Do not ban or force these phrases; discover fresh language from the actual facts.",
        "Do not turn metaphor into literal world truth. Do not add a person, dialogue, reaction, theft, grab, chase, arrival, departure, romance, injury, explosion or other new event unless supplied.",
        ...
        "Do not fall into a canned genre template. 'Mission' is a vocabulary option, not a fixed sequence. A mission frame may begin with a time, a room, a failure, a status shift, a sensory detail, or anything else the facts support. Every sequence should feel discovered, not filled in.",
