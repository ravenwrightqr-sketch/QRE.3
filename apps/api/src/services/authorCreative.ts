    ...
    [
      {
        ...
        content: [
          ...
          "The three finalists must not share one mood or one procedural grammar. Make them compete from materially different creative pressures. When the supplied reality carries emotion or relationship tension, actively search emotional and relational pressures as well as procedural ones; do not default all finalists to systems, diagnostics, bureaucracy, missions, protocols, or futuristic language.",
          ...
          "Penalize atmospheric vagueness. Ambiguity, impermanence, subtlety, transience, melancholy, emptiness, longing, and similar mood words are not a creative conception by themselves. They are valid pressures only when the supplied facts give them a concrete relational move, contrast, turn, callback, status shift, or other executable idea.",
