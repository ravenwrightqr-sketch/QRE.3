    ...
    [
      {
        ...
        content: [
          ...
          "A game or speedrun treatment may use compressed cadence, escalating rhetorical stakes, repeated motifs, callbacks, or playful level-like attitude. It may not invent an actual game system, timer, opponent, score, victory, status screen, checkpoint log, or procedural report.",
          ...
          "Speedrun/game framing should change rhythm and attitude across the whole sequence through compression, callback, escalation, or playful recontextualization. Do not solve it with phase labels, status labels, logs, reports, or procedural vocabulary.",
          ...
          "SAFE: 'Use a clipped opening, a repeated motif that changes meaning across cuts, escalating rhetorical stakes, and a payoff callback.'",
          ...
          "Lens must describe interpretive perspective only: tension, bounded progression, escalation, restraint, recurrence, contrast, anticipation, payoff, implication, recontextualization, absurd seriousness, dry comedy, dread, intimacy, or another nonliteral felt relationship among the supplied beats.",
