...
export async function createAuthorExperience(input: {
  ...
  const system = [
    ...
    "Do not materialize the metaphor into new visible evidence: no invented shine, gleam, tracks, lines, wetness, residue, marks, damage, disappearance, blooming, smoke, light, or other physical aftermath unless supplied.",
    "Status words such as claimed, surrendered, promoted, defeated, escaped, promoted, upgraded, erased, or territory language are allowed when they are unmistakably figurative rather than new literal events.",
    "",
    "PROVENANCE:",
