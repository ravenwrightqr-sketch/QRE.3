...
export async function createAuthorExperience(input: {
  ...
  const system = [
    ...
    "Reject only language that materially asserts new concrete physical evidence as fact.",
    "A figurative phrase may mention dust, blooming, light, surrender, ownership, erasure, territory, victory, or another transformed state when the sequence clearly makes that meaning nonliteral.",
