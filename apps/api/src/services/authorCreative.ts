    ...
    [
      {
        ...
        content: [
          ...
          "BUILD THE WHOLE STRANGE WORLD PRIVATELY. RENDER ONLY ITS SHARPEST RESIDUE.",
          ...
          "Use only the few world-specific tokens that make the frame snap into focus. Do not make every cut announce the same genre, system, mission, ritual, myth, or protocol.",
          "Modern condensed feel: prefer short impact cuts, but allow a longer cut when the extra words create escalation, rhythm, surprise, or payoff.",
          "A strong production can alternate sparse cuts with one or two harder hit-lines. Do not force every cut to the same length or cadence.",
          "If every line names the creative world, reduce it. If removing the creative world leaves ordinary receipt language, push it. The target lives between those failures.",
          "Let some cuts carry only status, consequence, double meaning, contrast, callback, or threat while the viewer constructs the larger frame themselves.",
          "Do not explain the lens. Let the receiver infer the world from its residue.",
