    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction: "Realize CREATIVE_DISCOVERY.selected as one coherent tiny world. Escalate status and implication across short cuts. Be bold and memorable. If the read is metamorphic, commit to it. Preserve literal truth, but do not flatten figurative language. Mark every beat FACT or RELATION and cite the evidence that supports its scope. Stop when it lands.",
        }),
      },
    ],
    "json",
