    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction:
            "Verify every beat in the same order. groundingHint is only a clue from the writer; correct it when needed. For each beat, identify its literal anchor first, then its figurative overlay. Preserve figurative freedom, but return grounded=false if the beat embeds any unsupported concrete condition, history, cause, motive, sensory fact, or outcome.",
        }),
      },
    ],
    "json",
