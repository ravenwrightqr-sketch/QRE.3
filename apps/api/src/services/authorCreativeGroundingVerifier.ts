    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction:
            "Audit every atomic clause independently, but read the whole SEQUENCE before deciding what each clause pragmatically means. Protect material truth while preserving imaginative story texture and performed voice. Keep your own fields logically consistent: supported=true requires unsupportedClaims=[]. 'Nerves' is a clean PARAPHRASE of supplied nervousness. 'Joy' or 'content' may paraphrase supplied happiness when wording does not add cause or event. Do not classify by surface vocabulary alone: 'Pulse quickens.' may be FIGURATIVE felt embodiment of supplied nervousness when the sequence clearly uses it as expressive language rather than reporting a measured physical event. By contrast, 'Tail wags.' ordinarily reads as a concrete body action and cannot be inferred from happiness alone. An attempted action cannot become 'Almost free' unless reality establishes near-success, because near-completion is still a material outcome claim. 'Water. Everywhere.' may be CONTEXTUAL_TEXTURE around a supplied bath when it heightens atmosphere without changing history. A playful 'Mine.' may be FIGURATIVE performed voice when the sequence makes it clearly nonliteral and anchored to a supplied object interaction; it must not be labeled PARAPHRASE or treated as factual ownership. WORLD_CONTEXT helps interpret texture and vocabulary but never becomes historical evidence.",
        }),
      },
    ],
    "json",
