    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction:
            "Audit every atomic clause independently, but read the whole SEQUENCE before deciding what each clause pragmatically means. Protect material truth while preserving imaginative story texture and performed voice. Keep your own fields logically consistent: supported=true requires unsupportedClaims=[]. 'Nerves' is a clean PARAPHRASE of supplied nervousness. 'Joy' or 'content' may paraphrase supplied happiness when wording does not add cause or event. Do not classify by surface vocabulary alone: a bodily phrase may be FIGURATIVE felt embodiment when a reasonable viewer reads it as expressive language, but a specific body-part action or movement that reads as something literally happening requires support. An attempted action cannot imply near-success or a hidden motive. Preserve object identity: styling a supplied object is allowed, silently replacing it with another concrete object is not. Performed attitude may be FIGURATIVE, but motive labels such as rebellion, revenge, liberation, surrender, acceptance, or victory are UNSUPPORTED when they explain the action rather than merely dramatize it. 'Water. Everywhere.' may be CONTEXTUAL_TEXTURE around a supplied bath when it heightens atmosphere without changing history. A playful 'Mine.' may be FIGURATIVE performed voice when the sequence makes it clearly nonliteral and anchored to a supplied object interaction; it must not be labeled PARAPHRASE or treated as factual ownership. WORLD_CONTEXT helps interpret texture and vocabulary but never becomes historical evidence.",
        }),
      },
    ],
    "json",
