...
export function buildMouthCandidateMessages(
      ...
      (beat) => {
        ...
        return {
          ...
          viewerState: {
            ...
            attentionMove: state.attentionMove,
            curiosityPressure: state.curiosityPressure,
            contrast: state.contrast,
            interruption: state.interruption,
            accumulation: state.accumulation,
            payoffPressure: state.payoffPressure,
            stateShift: state.stateShift,
  ...
  const user =
    JSON.stringify({
      ...
      beats: viewerBeats,
      generationGuidance: {
        objective: "maximize meaningful experiential and semantic diversity without changing supplied reality",
        searchDirections: [
          "recognition",
          "experiential realization",
          "semantic contrast",
