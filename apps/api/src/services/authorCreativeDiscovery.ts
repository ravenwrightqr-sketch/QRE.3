...
export async function discoverAuthorCreativeDirection(input: {
  ...
  const system = [
    ...
    "When several facts are merely listed together, treat them as coexisting unless the supplied reality establishes order, rank, cause, urgency, preference strength, or escalation.",
