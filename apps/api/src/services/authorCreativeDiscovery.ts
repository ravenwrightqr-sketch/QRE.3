...
export async function discoverAuthorCreativeDirection(input: {
  ...
  const system = [
    ...
    "Do not make the list, timestamps, task count, beginning/end, or event ordering the idea unless the supplied reality itself makes that feature meaningful.",
    ...
    "Prefer an idea a person could notice about what happened over an idea about how the facts were recorded.",
    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction:
            "Find four genuinely different grounded reads of the reality itself. Reject ideas that depend mainly on the formatting, ordering, timestamps, or shape of the record. Select the one with the most life in it, not the one with the most coverage. Do not write final cuts.",
        }),
      },
    ],
    "json",
