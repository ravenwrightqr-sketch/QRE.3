...
export async function discoverAuthorCreativeDirection(input: {
  ...
  const system = [
    ...
    "An action verb does NOT prove what condition existed before it. Dusted does not prove visible dust; cleaned does not prove grime; mopped does not prove a dirty floor. Build the figurative opponent/status from the supplied actions themselves, not from an invented unseen condition.",
