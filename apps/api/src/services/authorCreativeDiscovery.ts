    ...
    [
      { role: "system", content: system },
      {
        ...
        content: JSON.stringify({
          ...
          instruction:
            "Search several genuinely different grounded perceptions. Prefer reads where supplied facts recontextualize one another. Reject process summaries, service-scope summaries, time-plus-workload summaries, and business-context summaries. Select the strongest latent read first. Only then select the minimum evidence needed to make that perception playable. Do not write final cuts.",
        }),
      },
    ],
    "json",
