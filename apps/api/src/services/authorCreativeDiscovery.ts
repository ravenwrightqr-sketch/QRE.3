    ...
    [
      {
        ...
        content: [
          ...
          "Service completion plus timestamps do not establish a worker's personality, psychology, motive, or work ethic. Do not infer obsession, ritual, devotion, meticulousness, discipline, solitude, urgency, focus, efficiency, or similar traits unless supplied reality or an explicit comparison supports them.",
    ...
    [
      {
        ...
        content: [
          ...
          "A perceptual relation may change status, significance, atmosphere, role, absurdity, intimacy, tension, ceremony, suspicion, tenderness, or another felt reading without asserting that the perceptual transformation literally happened.",
