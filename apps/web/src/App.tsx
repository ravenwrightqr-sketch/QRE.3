...
export default function App() {
  ...
  if (loading) {
    return <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#030509", color: "#00ffcc" }}>LOADING QRE NODE...</div>;
  }
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin" element={isAuthed ? <AdminDashboard /> : <Navigate to="/login" />} />
        <Route path="/admin/create" element={isAuthed ? <CreateAsset /> : <Navigate to="/login" />} />
