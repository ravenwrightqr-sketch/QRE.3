...
const page: React.CSSProperties = { minHeight: "100vh", background: "#050608", color: "#f4f6f8", fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" };
...
const hero: React.CSSProperties = { maxWidth: 1100, margin: "0 auto", padding: "clamp(90px, 14vw, 170px) 24px 130px" };
const eyebrow: React.CSSProperties = { margin: 0, color: "#00e5a0", fontSize: 11, fontWeight: 800, letterSpacing: 3 };
const title: React.CSSProperties = { margin: "18px 0 24px", fontSize: "clamp(52px, 9vw, 108px)", lineHeight: .93, letterSpacing: -6, fontWeight: 850 };
const lede: React.CSSProperties = { maxWidth: 680, margin: 0, color: "rgba(255,255,255,.58)", fontSize: "clamp(17px, 2vw, 21px)", lineHeight: 1.55 };
const actions: React.CSSProperties = { display: "flex", flexWrap: "wrap", gap: 12, marginTop: 34 };
const primary: React.CSSProperties = { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, padding: "14px 22px", background: "#f4f6f8", color: "#050608", textDecoration: "none", fontWeight: 850 };
const secondary: React.CSSProperties = { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, padding: "14px 22px", border: "1px solid rgba(255,255,255,.15)", color: "#fff", textDecoration: "none", fontWeight: 700 };
const featureGrid: React.CSSProperties = { maxWidth: 1100, margin: "0 auto", padding: "0 24px 130px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: 16 };
const feature: React.CSSProperties = { padding: 28, borderRadius: 22, border: "1px solid rgba(255,255,255,.09)", background: "rgba(255,255,255,.025)" };
const number: React.CSSProperties = { color: "#00e5a0", fontSize: 11, fontWeight: 800, letterSpacing: 2 };
const bottom: React.CSSProperties = { maxWidth: 1100, margin: "0 auto", padding: "90px 24px 120px", borderTop: "1px solid rgba(255,255,255,.08)" };
const bottomTitle: React.CSSProperties = { margin: "16px 0 28px", fontSize: "clamp(40px, 6vw, 72px)", lineHeight: 1, letterSpacing: -4 };
const footer: React.CSSProperties = { padding: "36px 24px 60px", textAlign: "center", color: "rgba(255,255,255,.3)", fontSize: 12 };
