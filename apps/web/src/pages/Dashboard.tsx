...
type Experience = { id: string; slug: string; status: string; tier: string; flowId: string | null; displayName?: string | null };
const orbit = [
...
export default function Dashboard() {
  ...
  async function awaken() {
    ...
    try {
      setCreating(true);
      const compiled = await compileExperience({ prompt: text, assetId: activeObject?.id });
